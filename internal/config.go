...
type Config struct {
	...
	DtrackParentProjectLabelKey string   `yaml:"dtrackParentProjectLabelKey" env:"SBOM_DTRACK_PARENT_PROJECT_LABEL_KEY" flag:"dtrack-parent-project-label-key"`
...
var (
	...
	ConfigKeyDependencyTrackDtrackParentProjectLabelKey = "dtrack-parent-project-label-key"
