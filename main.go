...
func newRootCmd() *cobra.Command {
	...
	rootCmd.PersistentFlags().String(internal.ConfigKeyDependencyTrackDtrackParentProjectLabelKey, "", "Dependency-Track: kubernetes label-key for determining parent project")
